          ...
          <div>
            <div className="mb-4 flex items-center gap-3">
              ...
              <h2 className="font-display text-2xl font-bold text-slate-900">
                {findCategory(activeCategory)!.label}
              </h2>
            </div>
          ...
          <div>
            <div className="mb-4 flex items-center gap-3">
              ...
              <h2 className="font-display text-2xl font-bold text-slate-900">
                {findCategory(activeCategory)!.label} —{" "}
                {
                  findCategory(activeCategory)!.subcats.find((s: any) => s.id === activeSubcat)!
                    .label
                }
              </h2>
            </div>
            ...
            <div className="space-y-3">
              {exercisesForSubcat(activeCategory, activeSubcat).map((ex: Exercise) => (
                <div
                  key={ex.slug}
                  className="flex items-center justify-between rounded-lg border border-border p-3 bg-white shadow-sm"
                >
                  ...
                  <div className="flex flex-col items-end gap-2">
                    ...
                    <button
                      ...
                      aria-label={`AI tracked exercise: ${ex.name}`}
                    >
                      ai tracked exercise
                    </button>
                  </div>
